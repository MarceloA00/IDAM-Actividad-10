 ...
 */
var walkingChallenges = ["Walk up an incline for 1 kilometer", "Walk 5 kilometers"]
var runningChallenges = ["Run 10 kilometers", "Run 25 kilometers"]
...
} else if !committedChallenges.isEmpty {
